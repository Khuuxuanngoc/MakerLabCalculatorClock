...
void loop()
{
    ...
    if (ready && millis() - ms > 100)
    {
        ...
        valueRange.set("values/[0]/[2]", count);
        count++;

        // For Google Sheet API ref doc, go to https://developers.google.com/sheets/api/reference/rest/v4/spreadsheets.values/append

        bool success = GSheet.values.append(&response /* returned response */, KXN_spreadsheetId /* spreadsheet Id to append */, "Sheet1!B3" /* range to append */, &valueRange /* data range to append */);
        if (success)
