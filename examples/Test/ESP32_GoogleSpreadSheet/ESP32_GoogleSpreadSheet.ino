 ...
 * VIDEO: https://www.youtube.com/watch?v=u7TYu61l0t4&t=1343s
 */
...
#define On_Board_LED_PIN  18 // vietesp32
...
const char* ssid = "nk";  //--> Your wifi name
const char* password = "30121992"; //--> Your wifi password
//----------------------------------------

// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbwdl98Gwbmhwqrs_wl-3UKx4_A0unWCP9hTF6RHU-UjLjqRR7ehLtMk5QbbjawsKezU/exec";
...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    // kxn test speed api
    // Send_Data_URL = "https://blynk.cloud/external/api/getAll?token=bw9Dlfusw60bHR6YVmZux9S_RSOmw2iM";
