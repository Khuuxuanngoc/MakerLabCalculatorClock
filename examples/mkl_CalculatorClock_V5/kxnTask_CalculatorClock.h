...
void ReadEeprom()
{
  ...
  if (this->clockEeprom.firstCheck != EEPROM_CALCULATOR_CLOCK_CHECK_FIRST_VALUE)
  {
    ...
    this->clockEeprom.costValue[0] = 200;
    this->clockEeprom.costValue[1] = 350;
    this->clockEeprom.costValue[2] = 150;
    this->clockEeprom.costValue[3] = 195;
    this->clockEeprom.costValue[4] = 240;

    this->clockEeprom.costValue[5] = 200;
    this->clockEeprom.costValue[6] = 350;
    this->clockEeprom.costValue[7] = 150;
    this->clockEeprom.costValue[8] = 195;
    this->clockEeprom.costValue[9] = 240;

    this->clockEeprom.minFreeValue[0] = 10;
    this->clockEeprom.minFreeValue[1] = 10;
    this->clockEeprom.minFreeValue[2] = 10;
    this->clockEeprom.minFreeValue[3] = 10;
    this->clockEeprom.minFreeValue[4] = 10;

    this->clockEeprom.minFreeValue[5] = 0;
    this->clockEeprom.minFreeValue[6] = 0;
    this->clockEeprom.minFreeValue[7] = 0;
    this->clockEeprom.minFreeValue[8] = 0;
    this->clockEeprom.minFreeValue[9] = 0;
